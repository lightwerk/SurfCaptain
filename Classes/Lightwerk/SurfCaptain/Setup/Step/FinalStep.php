...
class FinalStep extends \TYPO3\Setup\Step\AbstractStep
{
    ...
    protected function buildForm(\TYPO3\Form\Core\Model\FormDefinition $formDefinition)
    {
        ...
        $loggedOut->setProperty(
            'text',
            'You have automatically been logged out for security reasons since this is the final step. Refresh the page to log in again if you missed something.'
        );
