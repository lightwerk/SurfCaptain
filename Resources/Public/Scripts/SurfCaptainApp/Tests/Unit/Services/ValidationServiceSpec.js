...
describe('ValidationService', function () {
    ...
    it('should have a method doesStringStartWithSubstring', function () {
        expect(validationService.doesStringStartWithSubstring()).toBeDefined();
    });

    describe('->doesStringStartWithSubstring()', function () {
        it('should return true if passed string starts with passed substring.', function () {
            expect(validationService.doesStringStartWithSubstring('foobar', 'foo')).toEqual(true);
        });

        it('should return false if passed string starts with passed substring but case dont match.', function () {
            expect(validationService.doesStringStartWithSubstring('foobar', 'Foo')).toEqual(false);
        });

        it('should return false if passed string does not start with passed substring.', function () {
            expect(validationService.doesStringStartWithSubstring('foobar', 'obaaa')).toEqual(false);
        });

        it('should return false if passed string is empty.', function () {
            expect(validationService.doesStringStartWithSubstring('', 'oba')).toEqual(false);
        });
        ...
        it('should return the passed string if passed string does not start with passed substring.', function () {
            expect(validationService.doesStringStartWithSubstring('foobar', 'obaaa', 'foo')).toEqual('foo');
        });

        it('should return the passed string if passed string is empty.', function () {
            expect(validationService.doesStringStartWithSubstring('', 'oba', 'foo')).toEqual('foo');
        });
